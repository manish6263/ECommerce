    ...
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          ...
          {ishome && (
            <Banner
              src="https://res.cloudinary.com/dknhwuhzh/image/upload/v1682940847/ShopITAssets/bg1_jszeky_itnhlt.png"
              search="true"
          ...
          {ishome ? (
            ...
            <>
              {
                <Banner
                  src="https://res.cloudinary.com/dknhwuhzh/image/upload/v1682940900/ShopITAssets/bg2_a9w4ja_xdowkn.png"
                  search="false"
                  text="Search Items"
                />
              }
